...
namespace VirtualTeacherGenAIDemo.Server.Controllers
{
    ...
    public class ChatController : ControllerBase
    {
        ...
        public IResult Post([FromBody] ChatHistoryRequest chatHistory, string connectionId, CancellationToken token)
        {
            return _chatService.GetChat(chatHistory, connectionId, token);
        }
